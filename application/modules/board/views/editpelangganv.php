            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open('board/data/pelanggan/editPelanggan'); ?>
                        <form role="form" enctype="multipart/form-data">
                            <div class="card-body">
                                <input type="" class="form-control" id="inputName" name="id_pelanggan" value="<?php echo $pelanggan->id_pelanggan ?>">
